...
This script handles the generation of memes using random or user-provided images and quotes.
"""
...
def generate_meme(path=None, body=None, author=None):
    ...
    Args:
        path (str, optional): Path to an image file.
        body (str, optional): Quote body text.
        author (str, optional): Quote author name.
